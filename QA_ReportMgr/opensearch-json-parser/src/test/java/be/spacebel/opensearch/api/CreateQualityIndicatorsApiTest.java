 ...
 *
 * API tests for CreateQualityIndicatorsApi 
 */
public class CreateQualityIndicatorsApiTest {


    private CreateQualityIndicatorsApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://qcmms-cat.spacebel.be", CreateQualityIndicatorsApi.class, providers);
     ...
     */
    @Test
    public void createQualityIndicatorsTest() {
        QualityInformation body = null;
        String parentIdentifier = null;
        String datasetId = null;
        //api.createQualityIndicators(body, parentIdentifier, datasetId);
