 ...
 *
 * API tests for CreateMetricsApi 
 */
public class CreateMetricsApiTest {


    private CreateMetricsApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://qcmms-cat.spacebel.be", CreateMetricsApi.class, providers);
    ...
    public void createMetricsTest() {
        ...
        //api.createMetrics(body, parentIdentifier, datasetId);
