 ...
 *
 * API tests for UpdateMetricApi 
 */
public class UpdateMetricApiTest {


    private UpdateMetricApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://qcmms-cat.spacebel.be", UpdateMetricApi.class, providers);
    ...
    public void updateMetricTest() {
        QualityIndicator body = null;
        String parentIdentifier = null;
        String datasetId = null;
        String metricName = null;
        //api.updateMetric(body, parentIdentifier, datasetId, metricName);
