 ...
 *
 * API tests for DeleteMetricApi 
 */
public class DeleteMetricApiTest {


    private DeleteMetricApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://qcmms-cat.spacebel.be", DeleteMetricApi.class, providers);
    ...
    public void deleteMetricTest() {
        ...
        //api.deleteMetric(parentIdentifier, datasetId, metricName);
