 ...
 *
 * API tests for InsertApi 
 */
public class InsertApiTest {


    private InsertApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://qcmms-cat.spacebel.be", InsertApi.class, providers);
    ...
    public void insertTest() {
        ...
        //api.insert(body, parentIdentifier);
