 ...
 *
 * API tests for UpdateQualityIndicatorsApi 
 */
public class UpdateQualityIndicatorsApiTest {


    private UpdateQualityIndicatorsApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://qcmms-cat.spacebel.be", UpdateQualityIndicatorsApi.class, providers);
     ...
     */
    @Test
    public void updateQualityIndicatorsTest() {
        List<QualityIndicator> body = null;
        String parentIdentifier = null;
        String datasetId = null;
        //api.updateQualityIndicators(body, parentIdentifier, datasetId);
