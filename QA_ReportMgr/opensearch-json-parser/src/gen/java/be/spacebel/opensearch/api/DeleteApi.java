...
public interface DeleteApi  {
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "204", description = "Dataset has been deleted."),
        @ApiResponse(responseCode = "500", description = "Unexpected error") })
    public void delete(@PathParam("parentIdentifier") String parentIdentifier, @PathParam("datasetId") String datasetId);
}
