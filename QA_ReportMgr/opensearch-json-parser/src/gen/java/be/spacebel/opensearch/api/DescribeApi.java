 ...
 */
@Path("/")
public interface DescribeApi  {

    @GET
    @Path("/eo-catalog/series/{parentIdentifier}/description")
    @Operation(summary = "", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "201", description = "OSDD is successfully returned"),
        @ApiResponse(responseCode = "400", description = "Bad request."),
        @ApiResponse(responseCode = "500", description = "Unexpected error") })
    public void describe(@PathParam("parentIdentifier") String parentIdentifier);
}
